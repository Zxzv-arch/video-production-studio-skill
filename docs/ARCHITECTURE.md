...
- `references/` contains editorial, transcript, timeline, Remotion, B-roll, shot-direction, short-form, environment-fallback, finishing, and guided-workflow contracts.
